 ...
 */
function bwma_rubik_form_system_theme_settings_alter(&$form, $form_state, $form_id = NULL) {
  ...
  $form['rubik']['rubik_show_branding'] = array(
    ...
    '#default_value' => theme_get_setting('rubik_show_branding', 'bwma_rubik'),
  );
  $form['rubik']['rubik_inline_field_descriptions'] = array(
    ...
    '#default_value' => theme_get_setting('rubik_inline_field_descriptions', 'bwma_rubik'),
  );
  $form['rubik']['rubik_disable_sticky_sidebar'] = array(
    ...
    '#default_value' => theme_get_setting('rubik_disable_sticky_sidebar', 'bwma_rubik'),
  );
  $form['rubik']['rubik_disable_sidebar_in_form'] = array(
    ...
    '#default_value' => theme_get_setting('rubik_disable_sidebar_in_form', 'bwma_rubik'),
  );
  $form['rubik']['rubik_sidebar_field_ui'] = array(
    ...
    '#default_value' => theme_get_setting('rubik_sidebar_field_ui', 'bwma_rubik'),
    '#states' => array(
      'invisible' => array(
  ...
  $rubik_disable_sidebar_in_form = theme_get_setting('rubik_disable_sidebar_in_form', 'bwma_rubik');
