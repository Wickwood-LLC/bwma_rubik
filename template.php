 ...
 */
function bwma_rubik_breadcrumb($vars) {
  $output = '';
 ...
 */
function bwma_rubik_date_all_day_label() {
  return '';
}

function bwma_rubik_link_field_process($element, $form_state, $complete_form) {
 ...
 */
function bwma_rubik_field_multiple_value_form($variables) {
...
function bwma_rubik_js_alter(&$js) {
 ...
 */
function bwma_rubik_secondary_exposed_elements($vars) {
 ...
 */
function bwma_rubik_preprocess_secondary_exposed_elements(&$vars) {
  $element = $vars['element'];
...
function bwma_rubik_preprocess_html(&$vars) {
  $viewport = array(
   '#tag' => 'meta',
   '#attributes' => array(
     'name' => 'viewport',
